    ...
    return (
        <div className="login">
            ...
            <div className="login_container">
                ...
                <p className="text-cont">By signing-in you agree to Amazon's Conditions of Use & Sale. Please see our Privacy Notice, our Cookies Notice and our Interest-Based Ads Notice.</p>
